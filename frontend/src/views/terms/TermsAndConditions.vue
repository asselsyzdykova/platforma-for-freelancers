<template>
  <div class="terms-page">
    <div class="terms-container">
      ...
      <p class="last-updated"><strong>Last updated March 14, 2026</strong></p>

      <h2>AGREEMENT TO OUR LEGAL TERMS</h2>

      <p>
        We are BezRab ("Company," "we," "us," "our"), a company registered in Slovakia at
        Slančíkovej 595/1, Nitra 949 74.
      </p>

      <p>
        We operate the website
        <a href="https://www.bezrab.space" target="_blank" rel="noopener noreferrer">
      ...
      <p>
        The developed platform is a web application designed to connect freelancers and clients,
        with a special focus on students in Slovakia. The goal of the platform is to simplify
        collaboration between freelancers and clients by providing tools for communication, project
        management, invoicing, and secure payments. The platform allows freelancers to create
        profiles, present their skills, and apply for available projects. Clients can publish
        projects or internship opportunities and invite freelancers to participate. A special
        feature of the platform is the ability for companies to add internship offers for students
        free of charge, allowing students to apply and gain practical experience. Unlike many
        existing freelance marketplaces, the platform does not charge a commission for every
        contract between a freelancer and a client. Instead, the system is based on a subscription
        model that provides access to platform features. The platform includes a milestone-based
        payment system. Freelancers and clients first discuss project details through the built-in
        chat system. After agreeing on the project scope, the freelancer can create milestones with
        specific prices and deliverables. The client pays for the first milestone, and the
        freelancer begins working on the task. After the milestone is completed and approved by the
        client, the client proceeds to pay for the next milestone. This process continues until the
        project is fully completed. After finishing the project, both parties can leave reviews for
        each other, which helps maintain transparency and trust within the platform. In addition,
        freelancers can track the current status of their job applications and manage their
        financial transactions through the system. The platform also supports automatic invoice
        generation and integration with payment system such as Stripe. From a technical perspective,
        the platform is implemented using the Vue.js framework for the frontend and Laravel for the
        backend, ensuring efficient communication between the client interface and the server, as
        well as secure handling of user data and financial transactions.
      </p>

      <p>
        You can contact us by phone at +421950621838, email at
        <a href="mailto:bezrab.bakalarka@gmail.com">bezrab.bakalarka@gmail.com</a>, or by mail to
        Slančíkovej 595/1, Nitra 949 74, Slovakia.
      </p>

      <p>
        These Legal Terms constitute a legally binding agreement made between you, whether
        personally or on behalf of an entity ("you"), and BezRab, concerning your access to and use
      ...
      <p>
        ...
        is given, except if the changes apply to new functionality, and bug fixes, in which case
        the changes will be effective immediately. By continuing to use the Services after the
        effective date of any changes, you agree to be bound by the modified terms. If you disagree
        with such changes, you may terminate Services as per the section "TERM AND TERMINATION."
      </p>
      ...
      <p>
        ...
        <a href="mailto:bezrab.bakalarka@gmail.com">bezrab.bakalarka@gmail.com</a>. If we ever
      ...
      <p>
        ...
        <a href="mailto:bezrab.bakalarka@gmail.com">bezrab.bakalarka@gmail.com</a>.
      </p>
      ...
      <p>
        ...
        <a href="https://www.bezrab.space/privacy-policy" target="_blank" rel="noopener noreferrer">
          https://www.bezrab.space/privacy-policy
        </a>.
        By using the Services, you agree to be bound by our Privacy Policy, which is incorporated
        into these Legal Terms. Please be advised the Services are hosted in Slovakia. If you access
        the Services from any other region of the world with laws or other requirements governing
        personal data collection, use, or disclosure that differ from applicable laws in Slovakia,
        then through your continued use of the Services, you are transferring your data to Slovakia,
        and you expressly consent to have your data transferred to and processed in Slovakia.
      </p>
      ...
      <p>
        These Legal Terms are governed by and interpreted following the laws of Slovakia, and the
        ...
        your country to residence. BezRab and yourself both agree to submit to the non-exclusive
        jurisdiction of the courts of Nitra, which means that you may make a claim to defend your
        consumer protection rights in regards to these Legal Terms in Slovakia, or in the EU country
        in which you reside.
      </p>

      <h2 id="dispute-resolution">18. DISPUTE RESOLUTION</h2>
      <p>
        The European Commission provides information on consumer redress, including a list of
        dispute resolution bodies by country, which you can access. If you would like to bring this
      ...
      <p>
        BezRab<br />
        Slančíkovej 595/1<br />
        Nitra 949 74<br />
        Slovakia<br />
        Phone: +421950621838<br />
        <a href="mailto:bezrab.bakalarka@gmail.com">bezrab.bakalarka@gmail.com</a>
      </p>
    </div>
  </div>
