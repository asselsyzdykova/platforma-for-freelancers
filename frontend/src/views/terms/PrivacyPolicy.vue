<template>
  <div class="privacy-page">
    <div class="privacy-container">
      ...
      <p>
        This Privacy Notice for BezRab ("we," "us," or "our"), describes how and why we might
      ...
      <ul>
        ...
        <li>
          Use BezRab - web platform for freelancers. The developed platform is a web application
          designed to connect freelancers and clients, with a special focus on students in Slovakia.
          The goal of the platform is to simplify collaboration between freelancers and clients by
          providing tools for communication, project management, invoicing, and secure payments.
          The platform allows freelancers to create profiles, present their skills, and apply for
          available projects. Clients can publish projects or internship opportunities and invite
          freelancers to participate. A special feature of the platform is the ability for companies
          to add internship offers for students free of charge, allowing students to apply and gain
          practical experience. Unlike many existing freelance marketplaces, the platform does not
          charge a commission for every contract between a freelancer and a client. Instead, the
          system is based on a subscription model that provides access to platform features. The
          platform includes a milestone-based payment system. Freelancers and clients first discuss
          project details through the built-in chat system. After agreeing on the project scope, the
          freelancer can create milestones with specific prices and deliverables. The client pays for
          the first milestone, and the freelancer begins working on the task. After the milestone is
          completed and approved by the client, the client proceeds to pay for the next milestone.
          This process continues until the project is fully completed. After finishing the project,
          both parties can leave reviews for each other, which helps maintain transparency and trust
          within the platform. In addition, freelancers can track the current status of their job
          applications and manage their financial transactions through the system. The platform also
          supports automatic invoice generation and integration with payment system such as Stripe.
          From a technical perspective, the platform is implemented using the Vue.js framework for
          the frontend and Laravel for the backend, ensuring efficient communication between the
          client interface and the server, as well as secure handling of user data and financial
          transactions.
        </li>
      ...
      <p>
        ...
        access, steal, or modify your information. Learn more about how we keep your information
        safe.
      </p>
      ...
      <p>
        ...
        <a href="https://stripe.com/en-sk/privacy" target="_blank" rel="noopener noreferrer">
      ...
      <p>
        ...
        our Services and which we record in log files. Depending on how you interact with us, this
      ...
      <p>
        ...
        device used, this device data may include information such as your IP address (or proxy
      ...
      <h2 id="legal-bases">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</h2>
      ...
      <p>
        ...
        or fulfill our contractual obligations, to protect your rights, or to fulfill our legitimate
        business interests.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          comments, contributions, or other content to the Services) or otherwise interact with
          public areas of the Services, such personal information may be viewed by all users and may
          be publicly made available outside the Services in perpetuity. Similarly, other users will
          be able to view descriptions of your activity, communicate with you within our Services,
      ...
      <p>
        ...
        providers use their technology to provide advertising about products and services tailored to
      ...
      <p>
        ...
        <a href="mailto:bezrab.bakalarka@gmail.com">bezrab.bakalarka@gmail.com</a> or contact us
        by post at:
      </p>
      ...
      <h2 id="review-delete">13. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
